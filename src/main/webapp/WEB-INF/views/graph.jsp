        ...
        //<![CDATA[
          ...
          $(function() {
            ...
            if (canvasSupported()) {
              ...
              p.init(p.ajax("resources/neo/js/pjs/physics.pjs")+p.ajax("resources/neo/js/pjs/donut.pjs")+p.ajax("resources/neo/js/pjs/resource.pjs")+p.ajax("/knowledge-social/resources/neo/js/pjs/node.pjs")+p.ajax("resources/neo/js/pjs/edge.pjs")+p.ajax("resources/neo/js/pjs/graph.pjs")+p.ajax("resources/neo/js/pjs/network.pjs"));
              initialized = true;
